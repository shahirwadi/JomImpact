  ...
  Future<void> _register() async {
    ...
    if (!ok && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(vm.error ?? 'Registration failed'), backgroundColor: AppTheme.error));
    }
  }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Role selector
              const Text('I am a...', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: AppTheme.textDark)),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: _role == UserRole.organizer ? 'Organization / Full Name' : 'Full Name',
              ...
              Center(
                child: GestureDetector(
                  ...
                  child: const Text.rich(TextSpan(children: [
                    TextSpan(text: 'Already have an account? ', style: TextStyle(color: AppTheme.textMedium)),
...
class _RoleTile extends StatelessWidget {
  ...
  const _RoleTile({
    ...
    required this.label, required this.desc, required this.onTap,
  });
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Icon(icon, color: selected ? AppTheme.primary : AppTheme.textLight, size: 26),
            const SizedBox(height: 8),
            Text(label, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700,
              color: selected ? AppTheme.primary : AppTheme.textDark)),
            Text(desc, style: const TextStyle(fontSize: 11, color: AppTheme.textMedium)),
          ],
        ),
      ),
    );
